// Rozet Sistemi — Sadakat Rozetleri görsellerini kaynak klasörden
// (kullanıcının masaüstündeki 'rozetler/sadakat rozetleri') okuyup
// `assets/images/`e kopyalar — `process_badge_images.dart`/`process_module_
// mastery_badge_images.dart`/`process_collection_badge_images.dart`'ın AYNI
...
//
// Kullanım: `dart run tool/process_loyalty_badge_images.dart`
import 'dart:io';
...
const _sourceDir =
    r'C:\Users\MONSTER\OneDrive\Masaüstü\rozetler\sadakat rozetleri';
